...
panda_system_prompt = intro + zero_shot_example + environment_description + additional_knowledge
panda_system_prompt_for_few_shot = intro + zero_shot_example + environment_description + additional_knowledge

panda_first_generation_prompt = zero_shot_hint
panda_first_generation_prompt_for_few_shot = few_shot_hint